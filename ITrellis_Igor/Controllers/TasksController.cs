...
namespace ITrellis_Igor.Controllers
{
    public class TasksController : Controller
    {
        ...
        public ActionResult Index(int? id)
        {
            ...
            ViewData["CompletedTasks"] = db.Tasks.Where(i => i.IsCompleted == true).OrderBy(o=>o.DueDate).ToList();
            ViewData["NotCompletedTasks"] = db.Tasks.Where(i => i.IsCompleted == false).OrderBy(o => o.DueDate).ToList();
